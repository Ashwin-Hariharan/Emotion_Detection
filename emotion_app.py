...
image_size = (224, 224)  # Model expects 224x224 grayscale images
...
if uploaded_file is not None:
    ...
    image = Image.open(uploaded_file).convert("RGB")  # Convert to RGB (3 channels)
    ...
    face_image = img_to_array(image)  # Convert to array (224, 224, 1)
    ...
    st.image(uploaded_file, caption="Image Selected", use_container_width=True)
